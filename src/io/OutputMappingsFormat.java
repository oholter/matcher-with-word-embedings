...
public abstract class OutputMappingsFormat {
	...
	//Only for flat file format to give statistics
	protected void addClassMapping2Output(String iri_str1, String iri_str2, int dir_mapping, double conf, String inGS) throws Exception {
